...
pub fn check(a2l_file: &A2lFile) -> Vec<A2lError> {
    ...
    for module in a2l_file.project.module.values() {
        ...
        for t_axis in module.typedef_axis.values() {
        ...
        for t_characteristic in module.typedef_characteristic.values() {
...
fn check_axis_descr(
    ...
    module: &Module,
    objects: &FnvIndexMap<String, AnyObject>,
...
fn check_compu_method(
    ...
    module: &Module,
    compu_tabs: &FnvIndexMap<String, AnyCompuTab>,
    log_msgs: &mut Vec<A2lError>,
) {
...
fn check_group_structure(grouplist: &FnvIndexMap<String, Group>, log_msgs: &mut Vec<A2lError>) {
...
fn check_instance(
    instance: &Instance,
    typedefs: &FnvIndexMap<String, AnyTypedef>,
    log_msgs: &mut Vec<A2lError>,
) {
...
fn check_typedef_structure(
    ...
    for sc in typedef_structure.structure_component.values() {
